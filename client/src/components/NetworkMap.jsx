...
const layout = {
    ...
    // Upper Middle
    5: { x: 20, y: 40, labelX: 15, labelY: 41.5, anchor: 'end' },    // Fontana Oscura
    2: { x: 80, y: 40, labelX: 85, labelY: 41.5, anchor: 'start' },  // Porta Velaria
    
    // Middle Interchanges
    6: { x: 20, y: 65, labelX: 15, labelY: 66.5, anchor: 'end' },    // Borgo Sereno
    8: { x: 50, y: 65, labelX: 50, labelY: 57, anchor: 'middle' },   // Torre Cinerea
    3: { x: 80, y: 65, labelX: 85, labelY: 66.5, anchor: 'start' },  // Crocevia del Falco
    
    // Lower Middle
    7: { x: 20, y: 90, labelX: 15, labelY: 91.5, anchor: 'end' },    // Viale dei Mosaici
    9: { x: 50, y: 90, labelX: 50, labelY: 99, anchor: 'middle' },   // Campo dell'Eco
...
const getPastelColor = (colorStr) => {
    switch(colorStr.toLowerCase()) {
        ...
        case 'blue': return '#a0c4ff';   
        case 'green': return '#caffbf';  
        case 'yellow': return '#fdffb6'; 
            ...
            >
                <defs>
                    <filter id="soft-shadow" x="-50%" y="-50%" width="200%" height="200%">
                        <feDropShadow dx="0" dy="1.5" stdDeviation="2" floodColor="#b19cd9" floodOpacity="0.5" />
                    </filter>
                </defs>
